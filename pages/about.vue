    ...
    <section class="pb-16">
        <div class="container">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 md:items-center lg:max-w-5xl mx-auto">
                <img class="w-full md:h-2/3 object-cover object-top rounded-2xl dark:brightness-75" src="~/assets/img/me.jpg" alt="">
                <div class="space-y-6">
                    <p class="text">
        ...
        <div class="container">
            <div class="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 gap-24 items-center">
                <div class="space-y-6">
                    <p class="text">
                ...
                <div class="grid grid-cols-5 gap-5 bg-gray-50 p-4 md:p-8 rounded-xl">
